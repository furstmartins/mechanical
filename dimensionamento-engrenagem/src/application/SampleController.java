...
//		tfAnguloPressao2.setText("20");
		...
		preencheGridPane("Relação de transmissão (i)", i);
	...
	private void calculaNormalizado() {
		...
		preencheGridPane("Tenssão Máxima [MPa]", tensaoMaxima);
